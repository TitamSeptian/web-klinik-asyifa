...
@section('content')
    ...
    <a href="{{ route('tags.create') }}" class="btn btn-sm mb-4 my-4"><i class='bx bx-plus'></i> Tambah</a>
            ...
            <tbody class="divide-y-2">
                @foreach ($tags as $tag)
                    <tr class="bg-white border-b ">
                        ...
                        <td class="td font-medium text-gray-900">{{ $tag->name }}</td>
                        <td class="td flex space-x-2 justify-end">
                            <a class="btn btn-sm" href="{{ route('tags.edit', $tag->id) }}">Edit</a>
